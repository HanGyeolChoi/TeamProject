...
namespace TextRPG_project
{
    internal partial class Program
    {
        public class Store
        {
            public void StoreMenu(List<Item> items, Character player)
            {
                Console.Clear();
            ...
            void BuyMenu(List<Item> items, Character player)
            {
                Console.Clear();
            ...
            void SellMenu(List<Item> items, Character player)
            {
                Console.Clear();
